<template>
    <div>
        <div style="display: flex;justify-content: space-between">
            <el-button icon="el-icon-plus" type="primary" @click="showAddSalary">添加账套</el-button>
    ...
    <el-button :disabled="activeItemIndex==0?true:false" @click="preStep">{{
            activeItemIndex == 10
                ? '取消'
                : '上一步'
        }}</el-button>
...
export default {
    ...
    methods: {
        ...
        deleteSalary (data) {
            this.$confirm('此操作将永久删除【' + data.name + '】内容, 是否继续?', '提示', {
