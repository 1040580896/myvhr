...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "xiaokaixin.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "xiaokaixin.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "xiaokaixin.mail.routing.key";
}
